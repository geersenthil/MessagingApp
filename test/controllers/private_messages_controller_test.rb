...
class PrivateMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create private_message" do
    assert_difference('PrivateMessage.count') do
      post private_messages_url, params: { private_message: { directmessage: @private_message.directmessage } }
    end
  ...
  test "should update private_message" do
    patch private_message_url(@private_message), params: { private_message: { directmessage: @private_message.directmessage } }
